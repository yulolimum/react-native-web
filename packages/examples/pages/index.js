  ...
  return (
    <View style={styles.app}>
      ...
      <Text style={styles.text}>
        <Link href="https://github.com/necolas/react-native-web">React Native for Web</Link> example app built on Next.js
      </Text>

      <View accessibilityRole="list">
        {process.env.pages.map((page) => (
          <View accessibilityRole="listitem" style={styles.listitem}>
            <Link href={'/' + page} style={styles.pageLink}>{page}</Link>
          </View>
        ))}
      </View>
    </View>
